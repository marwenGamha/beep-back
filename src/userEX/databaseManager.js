...
module.exports.queryTableOpenPay = async (TABLE_NAME) => {
  const params = {
    TableName: TABLE_NAME, 
    ProjectionExpression: 'doc_creating_date',
...
module.exports.queryTableClosePay = async (TABLE_NAME) => {
  const params = {
    TableName: TABLE_NAME, 
    ProjectionExpression: 'path_doc,updated_date',
...
module.exports.queryTableOpenPayAll = async (TABLE_NAME) => {
  const params = {
    TableName: TABLE_NAME, 
...
module.exports.queryTableByDate = async (TABLE_NAME,date) => {
  const params = {
    TableName: TABLE_NAME, 
...
module.exports.updateItemProcces = (
  TABLE_NAME,
  id,
  paramName,
  paramValue
...
module.exports.updateElementList = (
  ...
  const params = {
    ...
    // },
        ...
        // UpdateExpression: `SET #paramName = list_append(:paramValue, #paramName)`,
...
module.exports.updateconfirm = (TABLE_NAME, id) => {
  const params = {
    TableName: TABLE_NAME,
    Key: {
      id: id,
...
module.exports.downVoteBonus = (TABLE_NAME, id,sortkey,bonusVal) => { 
  const params = {
    TableName: TABLE_NAME,
    Key: {
      id: id,
